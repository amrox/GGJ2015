...
This game is implemented as a single python script. Currently the defender is designed to run on Mac OS X. The attacked works on OS X or Windows, but has additional features on windows.
